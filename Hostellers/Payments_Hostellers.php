                        ...
                        <div class="card card-4">
                            <div class="card-body">
                                <h2 class="title">Payments</h2>
                                    ...
                                    <div class="row row-space">
                                        ...
                                        <div class="col-2">
                                            <div class="input-group">
                                                ...
                                                <div class="p-t-10">
                                                    <label class="radio-container m-r-45">Daily Basis (Rs : 100)
                                                        <input type='radio' value='daily' name="pay" Checked="true"/>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <label class="radio-container">Weekly Basis (Rs : 650)
                                                        <input type='radio' value='weekly' name="pay" />
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <label class="radio-container">Monthly Basis (Rs : 2000)
                                                        <input type='radio' value='monthly' name="pay" />
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="p-t-15">
                                        <input type="submit" name="submit" value="Payment" class="btn btn--radius-2 btn--blue" />
